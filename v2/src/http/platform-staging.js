...
export const stagingWebRoot = path.resolve(currentDir, "../../web");

export function createStagingPlatform({
  pool,
  services = null,
  realtimeBroker = null,
  ...
  app.get(/.*/, (req, res, next) => {
    ...
    return res.sendFile(path.join(stagingWebRoot, "platform.html"));
  });
